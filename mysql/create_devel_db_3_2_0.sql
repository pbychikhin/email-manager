...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `GetAccountSpoolDir`(sp_name VARCHAR(510), sp_caller ENUM('smtp', 'pop', 'imap')) RETURNS varchar(255) CHARSET ascii
    MODIFIES SQL DATA
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `GetFullSysName`() RETURNS varchar(256) CHARSET ascii
    READS SQL DATA
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `GetNamePart`(sp_name VARCHAR(510), sp_delim CHAR(1), sp_partname CHAR(10)) RETURNS varchar(255) CHARSET ascii
    READS SQL DATA
    SQL SECURITY INVOKER
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_apache_digauth` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `get_apache_digauth`(sp_name VARCHAR(255), sp_realm VARCHAR(255)) RETURNS char(32) CHARSET ascii
    READS SQL DATA
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `sasl_getlogin`(sp_name VARCHAR(510)) RETURNS varchar(510) CHARSET ascii
    READS SQL DATA
    SQL SECURITY INVOKER
BEGIN
	DECLARE sp_acname VARCHAR(255) DEFAULT GetNamePart(sp_name, '@', 'name');
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `sasl_getpass`(sp_name VARCHAR(510)) RETURNS varchar(64) CHARSET ascii
    READS SQL DATA
    SQL SECURITY INVOKER
BEGIN
	    DECLARE sp_acname VARCHAR(255) DEFAULT GetNamePart(sp_name, '@', 'name');
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `account_del`(
		sp_domain varchar(255),
		sp_name varchar(255))
    MODIFIES SQL DATA
THISPROC: BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `account_mod`(
		sp_domain varchar(255),
		sp_name varchar(255),
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `alias_add`(
		sp_name varchar(255),
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `alias_del`(
		sp_name varchar(255),
		sp_value varchar(255))
    MODIFIES SQL DATA
THISPROC: BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `alias_mod`(
		sp_name varchar(255),
		sp_newname varchar(255),
		sp_value varchar(255), 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `domain_add`(
		sp_name varchar(255),
		sp_active tinyint(1),
		sp_public tinyint(1))
    MODIFIES SQL DATA
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `domain_del`(
		sp_name varchar(255))
    MODIFIES SQL DATA
THISPROC: BEGIN	
		SET @last_proc_state = 'NOPROBLEM';
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `domain_mod`(
		sp_name varchar(255),
		sp_newname varchar(255),
		sp_active tinyint(1),
		sp_public tinyint(1),
...
-- Dump completed on 2016-09-11 14:00:15
...
INSERT INTO sysinfo(pname, pvalue) VALUES('vminor', '2');
